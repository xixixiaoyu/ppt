...
const faqs = [
  { q: '这是正式内容吗？', a: '否。本模板所有文字均为示例/占位。' },
  { q: '是否支持背景切换？', a: '支持。使用 Ctrl/⌘ + Shift + P 打开设置。' },
  { q: '是否需要联网？', a: '不需要。本示例使用本地静态资源与内联 SVG 动效。' },
]
...
<template>
  ...
  >
    <div class="mb-6">
      ...
      <p class="mt-2 text-slate-600">简明问答；可点击展开/收起。</p>
    </div>
    ...
    <ul class="space-y-3">
      ...
      >
        ...
        >
          ...
          <svg
            class="h-4 w-4 text-slate-700 transition-transform"
        ...
        <div
          v-show="open === i"
          class="px-6 pb-6 text-slate-700 text-sm leading-relaxed"
        >
          {{ item.a }}
        </div>
      </li>
