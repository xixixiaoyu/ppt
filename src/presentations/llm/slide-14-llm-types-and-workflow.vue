...
import { ArrowRightIcon, CpuChipIcon, LightBulbIcon } from '@heroicons/vue/24/outline'
  ...
  <Section>
    <Card padding="xl" class="grid place-items-center relative overflow-hidden">
      ...
      <div class="absolute inset-0 -z-0 opacity-20 pointer-events-none">
        ...
        >
          ...
          <g filter="url(#blur-flow)">
            ...
            <circle cx="100" cy="500" r="150" fill="url(#g-flow)" opacity="0.5" />
          </g>
        </svg>
      </div>
      ...
      <div class="relative z-10 w-full max-w-6xl mx-auto flex flex-col gap-6 h-full">
        ...
        <!-- Part 1: QA Workflow -->
        <div class="bg-white/50 backdrop-blur-sm rounded-xl p-5 border border-white/40 shadow-sm">
          ...
          <div class="flex flex-col md:flex-row items-center justify-between gap-2 text-sm">
            ...
            <ArrowRightIcon class="w-4 h-4 text-slate-400 rotate-90 md:rotate-0" />
            ...
            >
              ...
              <span class="text-xs text-indigo-600">Inference (Next Token Prediction)</span>
            </div>
            <ArrowRightIcon class="w-4 h-4 text-slate-400 rotate-90 md:rotate-0" />
            ...
            >
              ...
              <span class="text-xs text-slate-500">De-tokenization & Output</span>
            </div>
          </div>
        </div>
          ...
          >
            <div class="flex items-center gap-3 mb-3 border-b border-slate-100 pb-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">General LLMs (e.g., GPT-4, Claude 3.5)</p>
              </div>
            </div>
            <ul class="space-y-3 text-sm text-slate-700 flex-1">
              <li class="flex gap-2">
                <span class="text-blue-500 font-bold">•</span>
                <span><strong>核心特点：</strong> 响应速度快，通用性强，擅长广泛的任务。</span>
              </li>
              <li class="flex gap-2">
                <span class="text-blue-500 font-bold">•</span>
                <span
                  ><strong>工作机制：</strong> 基于海量数据训练，直接预测下一个最可能的
                  Token，类似“直觉”反应。</span
                >
              </li>
              <li class="flex gap-2">
                <span class="text-blue-500 font-bold">•</span>
                <span><strong>适用场景：</strong> 创意写作、摘要生成、简单问答、翻译、闲聊。</span>
              </li>
            </ul>
          </div>
          ...
          >
            <div class="flex items-center gap-3 mb-3 border-b border-slate-100 pb-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">Reasoning LLMs (e.g., o1, o3-mini)</p>
              </div>
            </div>
            <ul class="space-y-3 text-sm text-slate-700 flex-1">
              <li class="flex gap-2">
                ...
                <span
                  ><strong>核心特点：</strong> 擅长复杂逻辑，能够进行深度思考，但响应较慢。</span
                >
              </li>
              <li class="flex gap-2">
                <span class="text-purple-500 font-bold">•</span>
                <span
                  ><strong>工作机制：</strong> 引入<strong>思维链 (Chain of Thought)</strong
              ...
              <li class="flex gap-2">
                <span class="text-purple-500 font-bold">•</span>
                <span
                  ><strong>适用场景：</strong> 复杂数学、逻辑谜题、科学研究、深度编程任务。</span
                >
              </li>
            </ul>
          </div>
