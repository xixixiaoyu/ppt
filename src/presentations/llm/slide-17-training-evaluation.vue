        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="space-y-6">
            ...
            <div class="bg-indigo-50/50 rounded-xl p-5 border border-indigo-100">
              <h4 class="font-bold text-indigo-700 mb-2">1. 训练集 (Training Set)</h4>
              <p class="text-xs text-indigo-600/80 mb-2">用于“学习”知识的数据集。</p>
              <ul class="space-y-2">
            ...
            <div class="bg-amber-50/50 rounded-xl p-5 border border-amber-100">
              <h4 class="font-bold text-amber-700 mb-2">2. 验证集 (Validation Set)</h4>
              ...
              <ul class="space-y-2">
                <li class="flex items-start gap-2">
                  ...
                  >
                  <span class="text-slate-600 text-sm"
                    >验证集损失。若 Training Loss 降但 Val Loss 升，则为过拟合。</span
                  >
                </li>
              </ul>
            </div>

            <div class="bg-fuchsia-50/50 rounded-xl p-5 border border-fuchsia-100">
              <h4 class="font-bold text-fuchsia-700 mb-2">3. 测试集 (Test Set)</h4>
              ...
              <ul class="space-y-2">
                <li class="flex items-start gap-2">
                  <span
                    ...
                    >Benchmarks</span
                  >
                  <span class="text-slate-600 text-sm">MMLU, C-Eval 等通用榜单。</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="space-y-4">
              ...
              >
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-bold text-emerald-800">训练成功 (Success)</h4>
                    <p class="text-sm text-emerald-700 mt-1">
                      Training Loss 和 Validation Loss 同步下降并趋于收敛。泛化能力强。
                    </p>
                  </div>
                </div>
                <!-- Success Curve -->
                <div class="w-full bg-white/60 rounded-lg p-2 border border-emerald-100/50">
              ...
              >
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h4 class="font-bold text-amber-800">过拟合 (Overfitting)</h4>
                    <p class="text-sm text-amber-700 mt-1">
                      Training Loss 继续下降，但
                      <span class="font-bold">Validation Loss 开始上升</span>。模型在“死记硬背”。
                    </p>
                  </div>
                </div>
                <!-- Overfitting Curve -->
                <div class="w-full bg-white/60 rounded-lg p-2 border border-amber-100/50">
