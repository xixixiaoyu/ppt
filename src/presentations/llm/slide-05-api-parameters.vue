    ...
    <Card padding="xl" class="grid place-items-center relative overflow-hidden">
      ...
      <div class="relative z-10 w-full max-w-6xl mx-auto flex flex-col gap-6 h-full justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          >
            <div class="flex items-center gap-2 mb-2">
              <div class="p-1.5 rounded-lg bg-rose-100 text-rose-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
          ...
          >
            <div class="flex items-center gap-2 mb-2">
              ...
              <h3 class="font-bold text-slate-800 text-lg font-mono">response_format</h3>
            </div>
            <p class="text-sm text-slate-600 leading-relaxed">
              <strong>输出格式</strong>。设置为
              <code class="bg-slate-100 px-1 rounded text-xs">{"type": "json_object"}</code>。
              <br />
              <span class="text-xs text-slate-500 mt-1 block">
                效果：强制模型输出合法的 JSON 结构。对于构建结构化数据提取、API 接口对接非常关键。
              </span>
            </p>
          </div>
        </div>
